...
const EXAMPLE_GROUPS = [
  {
    ...
    items: [
      ...
      },
      {
        label: "広告の改善・費用対効果",
        icon: "💹",
        text: "店舗の新規集客でMeta広告を運用していますが、CPA（顧客獲得単価）が安定せず、どのクリエイティブが良いのか判断に迷います。広告の数字を見ながら改善案を考え、体験予約への成約率を上げていきたいです。",
      },
      {
        label: "認知拡大・イベント企画",
        icon: "🎯",
    ...
    items: [
      {
        label: "求人原稿・応募対応",
        icon: "📝",
        text: "店舗のスタッフ採用のために求人原稿を書いたり、応募者への連絡や面接日程の調整をしています。原稿に何を書けば良い人が集まるのかわからず、応募対応にも時間を取られています。採用活動を効率化して、良い応募を増やしたいです。",
      },
      {
        label: "面接・人材の見極め",
        icon: "🔎",
        text: "店舗のスタッフ採用の面接で、何を質問すれば長く働いてくれる人材を見極められるのか毎回悩みます。採用してもすぐ辞めてしまうことがあり、面接の質問設計と評価基準を整えて、ミスマッチを減らしたいです。",
      },
      {
        label: "マニュアル化・研修",
        icon: "📚",
        text: "店舗の新人スタッフへの業務の教え方が人によってバラバラで、育成に時間がかかっています。接客やオペレーションのマニュアルを整備して、誰が教えても同じ品質になる研修の仕組みを作りたいです。",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "目標からの逆算・KPI設計",
        icon: "🎯",
        text: "店舗の月の売上目標はあるのですが、そのために新規が何人、リピートが何人必要かという逆算ができていません。客単価・リピート率・稼働率などの数字を整理して、日々何を追えばいいかを明確にしたいです。",
      },
      {
        label: "競合・市場の分析",
        icon: "🔍",
    ...
    items: [
      {
        label: "業務の書き出し・整理",
        icon: "🗂️",
        text: "店舗経営でやるべきことが頭の中にあふれていて、何から手をつければいいか整理できていません。集客・採用・顧客対応・数字管理など、店舗経営で必要な業務をすべて書き出して、優先順位をつけて仕組み化したいです。",
      },
      {
        label: "予約管理・スケジュール調整",
        icon: "🗓️",
